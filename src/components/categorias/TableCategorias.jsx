  ...
  return (
    <div className="mt-5">
      ...
      <div className="transition-all ease-linear rounded-2xl mt-6">
        <table className="bg-white text-sm rounded-2xl table">
          <thead>
            <tr>
              <th className="text-left px-4 py-4 font-bold text-sm text-sky-500 uppercase">
                Fecha de creación
              </th>
              <th className="text-left px-4 py-4 font-bold text-sm text-sky-500 uppercase">
          ...
          <tbody className="divide-y divide-slate-200">
            {filteredProducts.map((p) => (
              <tr className="hover:bg-gray-100/50 cursor-pointer" key={p._id}>
                ...
                <th className="px-4 py-4 text-gray-700 uppercase font-light text-sm">
