...
import imagen_cuatro from "../assets/imagenes_sistema/Captura desde 2024-05-09 00-34-50.png";
    ...
    <>
      ...
      <section className=" bg-slate-100 py-20 px-10 flex gap-5 flex-col justify-center items-center">
        <div className="flex flex-col gap-3">
          ...
          <p className="w-1/2 mx-auto text-center text-sm font-medium text-slate-600">
            ...
            uso como para entregar a sus clientes facturación en minutos.
          </p>
        </div>
      </section>
      ...
      <section className=" bg-white py-14 px-10 flex gap-5 flex-col justify-center items-center">
        ...
        <article className="h-[100vh] overflow-y-scroll px-5 scroll-bar flex flex-col gap-5">
          ...
          <div className="">
            <div className="w-full h-full">
              <img className="rounded-2xl w-full h-full" src={imagen_dos} />
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-sky-500 p-6 shadow-2xl ring-1 ring-sky-500 sm:order-last sm:px-8 lg:p-12 bg-white">
            ...
            <ul className="mt-6 space-y-2">
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700">
                  Generar ventas, presupuestos,etc.
                </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700">Stock infinito.</span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700">Soporte las 24 horas</span>
              </li>
            </ul>
          ...
          <div className="rounded-2xl p-6 shadow-xl sm:px-8 lg:p-12 bg-white">
            ...
            <ul className="mt-6 space-y-2">
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Soporte 24 horas </span>
              </li>
            </ul>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            ...
            <div className="mt-16 sm:flex sm:items-center sm:justify-between">
              <div className="flex justify-center text-sky-500 font-bold text-xl sm:justify-start">
                Gestión Prisma
              </div>
